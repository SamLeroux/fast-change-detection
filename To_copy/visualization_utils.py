...
# sys.path.append('/home/hi-vision/')
# from Ugent.datasets.auto_annotate.scripts import detection_images
# global filename1
# print('outside')
# print(filename)
...
def visualize_boxes_and_labels_on_image_array(
    ...
    # print('printing filename in vis')
                ...
                if not skip_labels:
                  if not agnostic_mode:
                    if classes[i] in category_index.keys():
                      ...
                      # Refactor - functionality remains the some
                      jpgExtension = '.jpg'
                      filename = str(filename1) + jpgExtension
                      base_dir = '/home/hi-vision/Ugent/datasets/auto_annotate/New_test_set_Brighton/'
                      base_dir_image_output = '/home/hi-vision/Ugent/datasets/auto_annotate/image_output/'
                      src = "/".join([base_dir, 'day1', filename])

                      for vehicle_class in ['car', 'truck', 'bus']:
                           print(class_name + "Detected")
                           if class_name == vehicle_class:
                               number_of_vehicles += 1
                               shutil.copy2(src, base_dir_image_output + filename) # complete target filename given

                      print('number of V1')
                      print(number_of_vehicles)

                      # Copy file to folder based on number_of_vechicles

                      src = base_dir + 'day1/' + filename
                      dest = base_dir + 'vehicle_number/' + str(number_of_vehicles)+ '/' + filename
                      shutil.copy2(src, dest) # complete target filename given

                    else:
                    # print('no class of interest')
                      class_name = 'N/A'
                      shutil.copy2('/home/hi-vision/Ugent/datasets/auto_annotate/New_test_set_Brighton/day1/'+str(filename1)+'.jpg', '/home/hi-vision/Ugent/datasets/auto_annotate/image_output_person/'+str(filename1)+'.jpg')
    ...
    #         xml.gerenate_basic_structure(filename1)
    print('number of V2')
    print(number_of_vehicles)
    print('done')
    return image
